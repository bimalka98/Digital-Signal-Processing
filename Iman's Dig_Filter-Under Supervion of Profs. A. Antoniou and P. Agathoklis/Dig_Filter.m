...
%
% -------------------------------------------------------------------------
% IMPORTANT NOTE (for designing IIR filters using optimizaation methods): 
%
% The bfgs, dfp, and inex_lsearch functions are part of the MATLAB support materials of the following textbook:
...
% http://www.ece.uvic.ca/~optimization/SupportMaterials.html
% 
...
% please visit http://www.ece.uvic.ca/~imanmoaz
